...
export b_file="Higher_Higgs_pT_bkg.C"
export s_file="Higher_Higgs_pT_sig.C"
export o_file="Higgs_PT.pdf"
...
TFile::Open("Higgs_PT.root");
TH1F* h_ratio = new TH1F("h_ratio", "Signal to Background Ratio vs Higgs p_{T}", 50, 0, 500);
