...
/*
##########
Script to produce a Histogram of the signal weighted selected events, after applying the ggH cuts detailed in Gabrielli et al. (2016)
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   //
   TFile *hfile = new TFile("Higgs_PT.root", "UPDATE");
   h_sig->Write();
   hfile->Close();
}
