...
/*
##########
Script to produce a Histogram of the γ+jet background weighted selected events, with photon |η|<1.44, 100<MT<130, no isolated leptons
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   //
   //Define Histogram 
   TH1F* h_bkg = new TH1F("h_bkg", "Signal and #gamma+jet bkg. vs pT cut, MET>125", nbins, 0, nbins*bin_width);
   //
   ...
   //
   TFile *hfile = new TFile("E0=155_P0.root", "RECREATE");
   h_bkg->Write();
   hfile->Close();
}
